...
import './Loginform.css'; // Asegúrate de tener el archivo styles.css en la misma ubicación que este componente
                                    ...
                                    <div className="card-back">
                                        <div className="center-wrap">
                                            <div className="section text-center">
                                                ...
                                                <div className="form-group">
                                                    <input type="text" className="form-style" placeholder="User Name" />
